        ...
        <div className="grid max-w-6xl grid-cols-1 px-20 mx-auto mt-12 text-center sm:px-0 sm:grid-cols-1 md:mt-20 gap-x-8 md:grid-cols-3 gap-y-12 lg:gap-x-16 xl:gap-x-20">
          <div>
            <img
              ...
              src="https://files.cdn-files-a.com/uploads/9728499/800_66ec2f5c13b13.jpg"
              alt=""
            />
          ...
          <div>
            <img
              className="object-cover w-32 h-32 mx-auto rounded-full lg:w-44 lg:h-44 grayscale filter"
              src="https://files.cdn-files-a.com/uploads/9728499/800_66ecf95f46677.jpg"
              alt=""
            />
            <p className="mt-5 text-lg font-bold text-gray-900 sm:text-xl sm:mt-8 font-pj">
              Sourav Negi
          ...
          <div>
            <img
              className="object-cover w-32 h-32 mx-auto rounded-full lg:w-44 lg:h-44 grayscale filter"
              src="https://files.cdn-files-a.com/uploads/9728499/800_66ecf977c40cf.jpg"
              alt=""
            />
            <p className="mt-5 text-lg font-bold text-gray-900 sm:text-xl sm:mt-8 font-pj">
              Yogesh Saini
